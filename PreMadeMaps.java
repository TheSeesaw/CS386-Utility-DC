...
public class PreMadeMaps
{
	...
	public void createTestMapGrid( int width, int height )
	{
		JFrame mapFrame = new JFrame("Dungeons and Dragons Premade Map");
		
		mapFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		mapFrame.setLayout( new GridLayout ( width, height ) );
		...
		buttonGrid = new JButton[width][height];
		for ( int i = 0; i < height; i++ )
		{
			for ( int j = 0; j < width; j++ )
			{
	...
	*/
	...
	public static void main(String[] args)
	{
		...
		/*SwingUtilities.invokeLater( new Runnable() 
		{
			...
			public void run()
			{
				new MapGrid().createTestMapGrid( WIDTHFINAL, LENGTHFINAL );
			}
		});*/
